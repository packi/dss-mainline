...
insert into name_master values(2343 , 4 , "device_actions" , "Abschalten" , "de_DE" , "de" , "DE");
insert into name_master values(2344 , 5 , "device_actions" , "Aufheizen" , "de_DE" , "de" , "DE");
insert into name_master values(2345 , 6 , "device_actions" , "Abkochen und abkühlen" , "de_DE" , "de" , "DE");
insert into name_master values(2346 , 3 , "device_events" , "Kocher aufgesetzt" , "de_DE" , "de" , "DE");
insert into name_master values(2347 , 4 , "device_events" , "Aufheizen gestartet" , "de_DE" , "de" , "DE");
insert into name_master values(2348 , 5 , "device_events" , "Warmhalten gestartet" , "de_DE" , "de" , "DE");
insert into name_master values(2349 , 6 , "device_events" , "Aufheizen beendet,  auf Zieltemperatur abkühlen" , "de_DE" , "de" , "DE");
insert into name_master values(2350 , 7 , "device_events" , "Aufheizen beendet" , "de_DE" , "de" , "DE");
insert into name_master values(2351 , 8 , "device_events" , "Kocher abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(2352 , 9 , "device_events" , "Abkühlen beendet, Zieltemperatur erreichet" , "de_DE" , "de" , "DE");
insert into name_master values(2353 , 10 , "device_events" , "Warmhalten beendet" , "de_DE" , "de" , "DE");
insert into name_master values(2354 , 11 , "device_events" , "Aufheizen abgebrochen, Taste betätigt" , "de_DE" , "de" , "DE");
insert into name_master values(2355 , 12 , "device_events" , "Abkühlen abgebrochen, Taste betätigt" , "de_DE" , "de" , "DE");
insert into name_master values(2356 , 13 , "device_events" , "Warmhalten abgebrochen, Taste betätigt" , "de_DE" , "de" , "DE");
insert into name_master values(2357 , 14 , "device_events" , "Aufheizen beendet, warmhalten" , "de_DE" , "de" , "DE");
insert into name_master values(2358 , 15 , "device_events" , "Abkühlen beendet, warmhalten" , "de_DE" , "de" , "DE");
insert into name_master values(2359 , 16 , "device_events" , "Aufheizen abgebrochen, Kocher abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(2360 , 17 , "device_events" , "Abkühlen abgebrochen, Kocher abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(2361 , 18 , "device_events" , "Warmhalten abgebrochen, Kocher abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(2362 , 8 , "device_status" , "Betriebsmodus" , "de_DE" , "de" , "DE");
insert into name_master values(2363 , 5 , "device_actions_predefined" , "Abkochen und abkühlen" , "de_DE" , "de" , "DE");
insert into name_master values(2364 , 6 , "device_actions_predefined" , "Aufheizen" , "de_DE" , "de" , "DE");
insert into name_master values(2365 , 7 , "device_actions_predefined" , "Abschalten" , "de_DE" , "de" , "DE");
insert into name_master values(2366 , 5 , "device_actions_parameter" , "Warmhaltedauer" , "de_DE" , "de" , "DE");
insert into name_master values(2367 , 7 , "device_actions_parameter" , "Warmhaltedauer" , "de_DE" , "de" , "DE");
insert into name_master values(2368 , 6 , "device_actions_parameter" , "Warmhaltetemperatur" , "de_DE" , "de" , "DE");
insert into name_master values(2369 , 8 , "device_actions_parameter" , "Zieltemperatur" , "de_DE" , "de" , "DE");
insert into name_master values(2370 , 8 , "device_status_enum" , "Abkühlen" , "de_DE" , "de" , "DE");
insert into name_master values(2371 , 9 , "device_status_enum" , "Aufheizen" , "de_DE" , "de" , "DE");
insert into name_master values(2372 , 10 , "device_status_enum" , "Warmhalten" , "de_DE" , "de" , "DE");
insert into name_master values(2373 , 11 , "device_status_enum" , "Bereit" , "de_DE" , "de" , "DE");
insert into name_master values(2374 , 12 , "device_status_enum" , "Abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(2375 , 1 , "common_labels" , "Name" , "de_DE" , "de" , "DE");
insert into name_master values(2376 , 2 , "common_labels" , "dS Device GTIN" , "de_DE" , "de" , "DE");
insert into name_master values(2377 , 3 , "common_labels" , "Modell" , "de_DE" , "de" , "DE");
insert into name_master values(2378 , 4 , "common_labels" , "Modellvariante" , "de_DE" , "de" , "DE");
insert into name_master values(2379 , 5 , "common_labels" , "Artikel Kennzeichnung" , "de_DE" , "de" , "DE");
insert into name_master values(2380 , 6 , "common_labels" , "Produkt Kennzeichnung" , "de_DE" , "de" , "DE");
insert into name_master values(2381 , 7 , "common_labels" , "Hersteller" , "de_DE" , "de" , "DE");
insert into name_master values(2382 , 8 , "common_labels" , "Hersteller Kennung" , "de_DE" , "de" , "DE");
insert into name_master values(2383 , 9 , "common_labels" , "Geräteklasse" , "de_DE" , "de" , "DE");
insert into name_master values(2384 , 10 , "common_labels" , "Geräteklassen Version" , "de_DE" , "de" , "DE");
insert into name_master values(2385 , 4 , "device_actions" , "Stop" , "en_US" , "en" , "US");
insert into name_master values(2386 , 5 , "device_actions" , "Boil" , "en_US" , "en" , "US");
insert into name_master values(2387 , 6 , "device_actions" , "Boil and cool down" , "en_US" , "en" , "US");
insert into name_master values(2388 , 3 , "device_events" , "Kettle attached" , "en_US" , "en" , "US");
insert into name_master values(2389 , 4 , "device_events" , "Boiling started" , "en_US" , "en" , "US");
insert into name_master values(2390 , 5 , "device_events" , "Keeping warm started" , "en_US" , "en" , "US");
insert into name_master values(2391 , 6 , "device_events" , "Boiling finished, cooling down to target temperature" , "en_US" , "en" , "US");
insert into name_master values(2392 , 7 , "device_events" , "Boiling finished" , "en_US" , "en" , "US");
insert into name_master values(2393 , 8 , "device_events" , "Kettle released" , "en_US" , "en" , "US");
insert into name_master values(2394 , 9 , "device_events" , "Cooling down finished, target temperature reached" , "en_US" , "en" , "US");
insert into name_master values(2395 , 10 , "device_events" , "Keeping warm ended" , "en_US" , "en" , "US");
insert into name_master values(2396 , 11 , "device_events" , "Boiling aborted, button pressed" , "en_US" , "en" , "US");
insert into name_master values(2397 , 12 , "device_events" , "Cooling down aborted, button pressed" , "en_US" , "en" , "US");
insert into name_master values(2398 , 13 , "device_events" , "Keeping warm aborted, button pressed" , "en_US" , "en" , "US");
insert into name_master values(2399 , 14 , "device_events" , "Boiling finished, keeping warm now" , "en_US" , "en" , "US");
insert into name_master values(2400 , 15 , "device_events" , "Cooling down finished, keeping warm now" , "en_US" , "en" , "US");
insert into name_master values(2401 , 16 , "device_events" , "Boiling aborted, kettle released" , "en_US" , "en" , "US");
insert into name_master values(2402 , 17 , "device_events" , "Cooling down aborted, kettle released" , "en_US" , "en" , "US");
insert into name_master values(2403 , 18 , "device_events" , "Keeping warm aborted, button pressed" , "en_US" , "en" , "US");
insert into name_master values(2404 , 8 , "device_status" , "Operation Mode" , "en_US" , "en" , "US");
insert into name_master values(2405 , 5 , "device_actions_predefined" , "Boil and cool down" , "en_US" , "en" , "US");
insert into name_master values(2406 , 6 , "device_actions_predefined" , "Boil" , "en_US" , "en" , "US");
insert into name_master values(2407 , 7 , "device_actions_predefined" , "Stopping" , "en_US" , "en" , "US");
insert into name_master values(2408 , 5 , "device_actions_parameter" , "Keep warm Duration" , "en_US" , "en" , "US");
insert into name_master values(2409 , 7 , "device_actions_parameter" , "Keep warm Duration" , "en_US" , "en" , "US");
insert into name_master values(2410 , 6 , "device_actions_parameter" , "Target Temperature" , "en_US" , "en" , "US");
insert into name_master values(2411 , 8 , "device_actions_parameter" , "Target Temperature" , "en_US" , "en" , "US");
insert into name_master values(2412 , 8 , "device_status_enum" , "Cooling down" , "en_US" , "en" , "US");
insert into name_master values(2413 , 9 , "device_status_enum" , "Heating up" , "en_US" , "en" , "US");
insert into name_master values(2414 , 10 , "device_status_enum" , "Keeping warm" , "en_US" , "en" , "US");
insert into name_master values(2415 , 11 , "device_status_enum" , "Ready" , "en_US" , "en" , "US");
insert into name_master values(2416 , 12 , "device_status_enum" , "Kettle released" , "en_US" , "en" , "US");
insert into name_master values(2417 , 1 , "common_labels" , "Name" , "en_US" , "en" , "US");
insert into name_master values(2418 , 2 , "common_labels" , "dS Device GTIN" , "en_US" , "en" , "US");
insert into name_master values(2419 , 3 , "common_labels" , "Model" , "en_US" , "en" , "US");
insert into name_master values(2420 , 4 , "common_labels" , "Model Version" , "en_US" , "en" , "US");
insert into name_master values(2421 , 5 , "common_labels" , "Article Identifier" , "en_US" , "en" , "US");
insert into name_master values(2422 , 6 , "common_labels" , "Product Id" , "en_US" , "en" , "US");
insert into name_master values(2423 , 7 , "common_labels" , "Vendor" , "en_US" , "en" , "US");
insert into name_master values(2424 , 8 , "common_labels" , "Vendor Id" , "en_US" , "en" , "US");
insert into name_master values(2425 , 9 , "common_labels" , "Device Class" , "en_US" , "en" , "US");
insert into name_master values(2426 , 10 , "common_labels" , "Device Class Version" , "en_US" , "en" , "US");
insert into name_master values(2427 , 1 , "device_actions" , "Back!" , "nl_NL" , "nl" , "NL");
insert into name_master values(2428 , 2 , "device_actions" , "Dampfen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2429 , 3 , "device_actions" , "auuus" , "nl_NL" , "nl" , "NL");
insert into name_master values(2430 , 4 , "device_actions" , "Uitschakelen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2431 , 5 , "device_actions" , "Verwarmen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2432 , 6 , "device_actions" , "Koken en afkoelen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2433 , 3 , "device_events" , "Waterkoker neergezet" , "nl_NL" , "nl" , "NL");
insert into name_master values(2434 , 4 , "device_events" , "Verwarmen begonnen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2435 , 5 , "device_events" , "Warm houden begonnen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2436 , 6 , "device_events" , "Verwarmen beëindigd, naar gewenste temperatuur afkoelen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2437 , 7 , "device_events" , "Verwarmen beëindigd" , "nl_NL" , "nl" , "NL");
insert into name_master values(2438 , 8 , "device_events" , "Waterkoker opgetild" , "nl_NL" , "nl" , "NL");
insert into name_master values(2439 , 9 , "device_events" , "Afkoelen beëindigd, gewenste temperatuur bereikt" , "nl_NL" , "nl" , "NL");
insert into name_master values(2440 , 10 , "device_events" , "Warm houden beëindigd" , "nl_NL" , "nl" , "NL");
insert into name_master values(2441 , 11 , "device_events" , "Verwarmen afgebroken, op knop gedrukt" , "nl_NL" , "nl" , "NL");
insert into name_master values(2442 , 12 , "device_events" , "Afkoelen afgebroken, op knop gedrukt" , "nl_NL" , "nl" , "NL");
insert into name_master values(2443 , 13 , "device_events" , "warm houden afgebroken, op knop gedrukt" , "nl_NL" , "nl" , "NL");
insert into name_master values(2444 , 14 , "device_events" , "Verwarmen beëindigd, warm houden" , "nl_NL" , "nl" , "NL");
insert into name_master values(2445 , 15 , "device_events" , "Afkoelen beëindigd, warm houden" , "nl_NL" , "nl" , "NL");
insert into name_master values(2446 , 16 , "device_events" , "Verwarmen afgebroken, waterkoker opgetild" , "nl_NL" , "nl" , "NL");
insert into name_master values(2447 , 17 , "device_events" , "Afkoelen afgebroken, waterkoker opgetild" , "nl_NL" , "nl" , "NL");
insert into name_master values(2448 , 18 , "device_events" , "Warm houden afgebroken, waterkoker opgetild" , "nl_NL" , "nl" , "NL");
insert into name_master values(2449 , 8 , "device_status" , "Modus" , "nl_NL" , "nl" , "NL");
insert into name_master values(2450 , 5 , "device_actions_predefined" , "Koken en afkoelen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2451 , 6 , "device_actions_predefined" , "Verwarmen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2452 , 7 , "device_actions_predefined" , "Uitschakelen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2453 , 5 , "device_actions_parameter" , "Warmhoudtijdsduur" , "nl_NL" , "nl" , "NL");
insert into name_master values(2454 , 7 , "device_actions_parameter" , "Warmhoudtijdsduur" , "nl_NL" , "nl" , "NL");
insert into name_master values(2455 , 6 , "device_actions_parameter" , "Warmhoudtemperatuur" , "nl_NL" , "nl" , "NL");
insert into name_master values(2456 , 8 , "device_actions_parameter" , "Gewenste temperatuur" , "nl_NL" , "nl" , "NL");
insert into name_master values(2457 , 8 , "device_status_enum" , "Afkoelen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2458 , 9 , "device_status_enum" , "Verwarmen" , "nl_NL" , "nl" , "NL");
insert into name_master values(2459 , 10 , "device_status_enum" , "Warm houden" , "nl_NL" , "nl" , "NL");
insert into name_master values(2460 , 11 , "device_status_enum" , "Gereed" , "nl_NL" , "nl" , "NL");
insert into name_master values(2461 , 12 , "device_status_enum" , "Opgetild" , "nl_NL" , "nl" , "NL");
insert into name_master values(2462 , 1 , "common_labels" , "Naam" , "nl_NL" , "nl" , "NL");
insert into name_master values(2463 , 2 , "common_labels" , "dS apparaat GTIN" , "nl_NL" , "nl" , "NL");
insert into name_master values(2464 , 3 , "common_labels" , "Model" , "nl_NL" , "nl" , "NL");
insert into name_master values(2465 , 4 , "common_labels" , "Model variant" , "nl_NL" , "nl" , "NL");
insert into name_master values(2466 , 5 , "common_labels" , "Artikel aanduiding" , "nl_NL" , "nl" , "NL");
insert into name_master values(2467 , 6 , "common_labels" , "Product aanduiding" , "nl_NL" , "nl" , "NL");
insert into name_master values(2468 , 7 , "common_labels" , "Fabrikant" , "nl_NL" , "nl" , "NL");
insert into name_master values(2469 , 8 , "common_labels" , "Fabrikant aanduiding" , "nl_NL" , "nl" , "NL");
insert into name_master values(2470 , 9 , "common_labels" , "Apparaatcategorie" , "nl_NL" , "nl" , "NL");
insert into name_master values(2471 , 10 , "common_labels" , "Apparaatcategorie versie" , "nl_NL" , "nl" , "NL");
...
insert into name_device_properties values(38 , 9 , "base" , "dummy property value" , "dummy property value" , "" , "2" , "" , "");
...
insert into device_events values(19 , 11 , "dummyEventAlpha");
