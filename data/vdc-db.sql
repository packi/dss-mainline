...
insert into name_master values(1086 , 1 , "device_actions" , "Back!" , "nl_NL");
insert into name_master values(1087 , 2 , "device_actions" , "Dampfen" , "nl_NL");
insert into name_master values(1088 , 3 , "device_actions" , "auuus" , "nl_NL");
insert into name_master values(1089 , 1 , "device_actions" , "Backen" , "de_DE");
insert into name_master values(1090 , 2 , "device_actions" , "Dampfen" , "de_DE");
insert into name_master values(1091 , 4 , "device_actions" , "stoppen" , "nl_NL");
insert into name_master values(1092 , 5 , "device_actions" , "koken" , "nl_NL");
insert into name_master values(1093 , 6 , "device_actions" , "kook en afkoelen" , "nl_NL");
insert into name_master values(1094 , 3 , "device_events" , "ketel bevestigd" , "nl_NL");
insert into name_master values(1095 , 4 , "device_events" , "koken begonnen" , "nl_NL");
insert into name_master values(1096 , 5 , "device_events" , "warm houden begonnen" , "nl_NL");
insert into name_master values(1097 , 4 , "device_actions" , "Stop" , "en_US");
insert into name_master values(1098 , 5 , "device_actions" , "Boil" , "en_US");
insert into name_master values(1099 , 6 , "device_actions" , "Boil and cool down" , "en_US");
insert into name_master values(1100 , 3 , "device_events" , "Kettle attached" , "en_US");
insert into name_master values(1101 , 4 , "device_events" , "Boiling started" , "en_US");
insert into name_master values(1102 , 5 , "device_events" , "Keeping warm started" , "en_US");
insert into name_master values(1103 , 6 , "device_events" , "Boiling finished, cooling down to target temperature" , "en_US");
insert into name_master values(1104 , 7 , "device_events" , "Boiling finished" , "en_US");
insert into name_master values(1105 , 8 , "device_events" , "Kettle released" , "en_US");
insert into name_master values(1106 , 9 , "device_events" , "Cooling down finished, target temperature reached" , "en_US");
insert into name_master values(1107 , 10 , "device_events" , "Keeping warm ended" , "en_US");
insert into name_master values(1108 , 11 , "device_events" , "Boiling aborted, button pressed" , "en_US");
insert into name_master values(1109 , 12 , "device_events" , "Cooling down aborted, button pressed" , "en_US");
insert into name_master values(1110 , 13 , "device_events" , "Keeping warm aborted, button pressed" , "en_US");
insert into name_master values(1111 , 14 , "device_events" , "Boiling finished, keeping warm now" , "en_US");
insert into name_master values(1112 , 15 , "device_events" , "Cooling down finished, keeping warm now" , "en_US");
insert into name_master values(1113 , 16 , "device_events" , "Boiling aborted, kettle released" , "en_US");
insert into name_master values(1114 , 17 , "device_events" , "Cooling down aborted, kettle released" , "en_US");
insert into name_master values(1115 , 18 , "device_events" , "Keeping warm aborted, button pressed" , "en_US");
insert into name_master values(1116 , 8 , "device_status" , "Operation Mode" , "en_US");
insert into name_master values(1117 , 7 , "device_actions_predefined" , "Stopping" , "en_US");
insert into name_master values(1118 , 6 , "device_actions_predefined" , "Boil" , "en_US");
insert into name_master values(1119 , 5 , "device_actions_predefined" , "Baby Bottle Boiling" , "en_US");
insert into name_master values(1120 , 7 , "device_actions_parameter" , "Keep-Warm Duration" , "en_US");
insert into name_master values(1121 , 8 , "device_actions_parameter" , "Target Temperature" , "en_US");
insert into name_master values(1122 , 5 , "device_actions_parameter" , "Keep-warm Duration" , "en_US");
insert into name_master values(1123 , 6 , "device_actions_parameter" , "Target Temperature" , "en_US");
insert into name_master values(1124 , 8 , "device_status_enum" , "Cooling down" , "en_US");
insert into name_master values(1125 , 9 , "device_status_enum" , "Heating up" , "en_US");
insert into name_master values(1126 , 10 , "device_status_enum" , "Keeping warm" , "en_US");
insert into name_master values(1127 , 11 , "device_status_enum" , "Ready" , "en_US");
insert into name_master values(1128 , 12 , "device_status_enum" , "Kettle released" , "en_US");
insert into name_master values(1129 , 4 , "device_actions" , "Abschalten" , "de_DE");
insert into name_master values(1130 , 5 , "device_actions" , "Aufheizen" , "de_DE");
insert into name_master values(1131 , 6 , "device_actions" , "Abkochen und abkühlen" , "de_DE");
insert into name_master values(1132 , 3 , "device_events" , "Kocher aufgesetzt" , "de_DE");
insert into name_master values(1133 , 4 , "device_events" , "Aufheizen gestartet" , "de_DE");
insert into name_master values(1134 , 5 , "device_events" , "Warmhalten gestartet" , "de_DE");
insert into name_master values(1135 , 6 , "device_events" , "Aufheizen beendet,  auf Zieltemperatur abkühlen" , "de_DE");
insert into name_master values(1136 , 7 , "device_events" , "Aufheizen beendet" , "de_DE");
insert into name_master values(1137 , 8 , "device_events" , "Kocher abgehoben" , "de_DE");
insert into name_master values(1138 , 9 , "device_events" , "Abkühlen beendet, Zieltemperatur erreichet" , "de_DE");
insert into name_master values(1139 , 10 , "device_events" , "Warmhalten beendet" , "de_DE");
insert into name_master values(1140 , 11 , "device_events" , "Aufheizen abgebrochen, Taste betätigt" , "de_DE");
insert into name_master values(1141 , 12 , "device_events" , "Abkühlen abgebrochen, Taste betätigt" , "de_DE");
insert into name_master values(1142 , 13 , "device_events" , "Warmhalten abgebrochen, Taste betätigt" , "de_DE");
insert into name_master values(1143 , 14 , "device_events" , "Aufheizen beendet, warmhalten" , "de_DE");
insert into name_master values(1144 , 15 , "device_events" , "Abkühlen beendet, warmhalten" , "de_DE");
insert into name_master values(1145 , 16 , "device_events" , "Aufheizen abgebrochen, Kocher abgehoben" , "de_DE");
insert into name_master values(1146 , 17 , "device_events" , "Abkühlen abgebrochen, Kocher abgehoben" , "de_DE");
insert into name_master values(1147 , 18 , "device_events" , "Warmhalten abgebrochen, Kocher abgehoben" , "de_DE");
insert into name_master values(1148 , 8 , "device_status" , "Betriebsmodus" , "de_DE");
insert into name_master values(1149 , 7 , "device_actions_predefined" , "Abschalten" , "de_DE");
insert into name_master values(1150 , 6 , "device_actions_predefined" , "Aufheizen" , "de_DE");
insert into name_master values(1151 , 5 , "device_actions_predefined" , "Abkochen und abkühlen" , "de_DE");
insert into name_master values(1152 , 7 , "device_actions_parameter" , "Warmhaltedauer" , "de_DE");
insert into name_master values(1153 , 8 , "device_actions_parameter" , "Zieltemperatur" , "de_DE");
insert into name_master values(1154 , 5 , "device_actions_parameter" , "Warmhaltedauer" , "de_DE");
insert into name_master values(1155 , 6 , "device_actions_parameter" , "Warmhaltetemperatur" , "de_DE");
insert into name_master values(1156 , 8 , "device_status_enum" , "Abkühlen" , "de_DE");
insert into name_master values(1157 , 9 , "device_status_enum" , "Aufheizen" , "de_DE");
insert into name_master values(1158 , 10 , "device_status_enum" , "Warmhalten" , "de_DE");
insert into name_master values(1159 , 11 , "device_status_enum" , "Bereit" , "de_DE");
insert into name_master values(1160 , 12 , "device_status_enum" , "Abgehoben" , "de_DE");
...
insert into device_labels values(1 , 18 , "notes" , "overview:100");
...
insert into common_labels values(5 , "hardwareGuid" , "invisible");
...
insert into device_properties values(5 , 18 , "waterLevel" , 3 , "0" , "2300" , "0" , "50" , "milliliter" , "readonly;overview" );
...
insert into name_device_properties values(4 , 4 , "de_DE" , "Temperatur {value} Grad Celsius" , "Wassertemperatur" , "&deg; C" , "0");
...
insert into name_device_properties values(12 , 4 , "en_US" , "Temperature {value} &deg; C" , "Temperature" , "&deg; C" , "0");
...
insert into name_device_properties values(22 , 5 , "de_DE" , "Füllstand {value} &#37;" , "Füllstand" , "&#37:" , "0");
insert into name_device_properties values(23 , 5 , "en_US" , "Water level {value} &#37;" , "Water-level" , "&#37;" , "0");
drop table if exists "name_device_labels";
create table "name_device_labels" (id primary key,reference_id,lang_code,title,value);
insert into name_device_labels values(1 , 1 , "de_DE" , "Bemerkungen" , "Bitte prüfen Sie mit der Smartphone App, ob die iKettle Firmware auf dem aktuellsten Stand ist!");
insert into name_device_labels values(2 , 1 , "en_US" , "Notes" , "Please check with the Smartphone App if the iKettle Firmware is up-to-date!");
