...
insert into name_master values(1941 , 1 , "device_actions" , "Back!" , "nl_NL" , "nl" , "NL");
insert into name_master values(1942 , 2 , "device_actions" , "Dampfen" , "nl_NL" , "nl" , "NL");
insert into name_master values(1943 , 3 , "device_actions" , "auuus" , "nl_NL" , "nl" , "NL");
...
insert into name_master values(1946 , 4 , "device_actions" , "stoppen" , "nl_NL" , "nl" , "NL");
insert into name_master values(1947 , 5 , "device_actions" , "koken" , "nl_NL" , "nl" , "NL");
insert into name_master values(1948 , 6 , "device_actions" , "kook en afkoelen" , "nl_NL" , "nl" , "NL");
insert into name_master values(1949 , 3 , "device_events" , "ketel bevestigd" , "nl_NL" , "nl" , "NL");
insert into name_master values(1950 , 4 , "device_events" , "koken begonnen" , "nl_NL" , "nl" , "NL");
insert into name_master values(1951 , 5 , "device_events" , "warm houden begonnen" , "nl_NL" , "nl" , "NL");
insert into name_master values(1952 , 4 , "device_actions" , "Stop" , "en_US" , "en" , "US");
insert into name_master values(1953 , 5 , "device_actions" , "Boil" , "en_US" , "en" , "US");
insert into name_master values(1954 , 6 , "device_actions" , "Boil and cool down" , "en_US" , "en" , "US");
insert into name_master values(1955 , 3 , "device_events" , "Kettle attached" , "en_US" , "en" , "US");
insert into name_master values(1956 , 4 , "device_events" , "Boiling started" , "en_US" , "en" , "US");
insert into name_master values(1957 , 5 , "device_events" , "Keeping warm started" , "en_US" , "en" , "US");
insert into name_master values(1958 , 6 , "device_events" , "Boiling finished, cooling down to target temperature" , "en_US" , "en" , "US");
insert into name_master values(1959 , 7 , "device_events" , "Boiling finished" , "en_US" , "en" , "US");
insert into name_master values(1960 , 8 , "device_events" , "Kettle released" , "en_US" , "en" , "US");
insert into name_master values(1961 , 9 , "device_events" , "Cooling down finished, target temperature reached" , "en_US" , "en" , "US");
insert into name_master values(1962 , 10 , "device_events" , "Keeping warm ended" , "en_US" , "en" , "US");
insert into name_master values(1963 , 11 , "device_events" , "Boiling aborted, button pressed" , "en_US" , "en" , "US");
insert into name_master values(1964 , 12 , "device_events" , "Cooling down aborted, button pressed" , "en_US" , "en" , "US");
insert into name_master values(1965 , 13 , "device_events" , "Keeping warm aborted, button pressed" , "en_US" , "en" , "US");
insert into name_master values(1966 , 14 , "device_events" , "Boiling finished, keeping warm now" , "en_US" , "en" , "US");
insert into name_master values(1967 , 15 , "device_events" , "Cooling down finished, keeping warm now" , "en_US" , "en" , "US");
insert into name_master values(1968 , 16 , "device_events" , "Boiling aborted, kettle released" , "en_US" , "en" , "US");
insert into name_master values(1969 , 17 , "device_events" , "Cooling down aborted, kettle released" , "en_US" , "en" , "US");
insert into name_master values(1970 , 18 , "device_events" , "Keeping warm aborted, button pressed" , "en_US" , "en" , "US");
insert into name_master values(1971 , 8 , "device_status" , "Operation Mode" , "en_US" , "en" , "US");
insert into name_master values(1972 , 5 , "device_actions_predefined" , "Baby Bottle Boiling" , "en_US" , "en" , "US");
insert into name_master values(1973 , 6 , "device_actions_predefined" , "Boil" , "en_US" , "en" , "US");
insert into name_master values(1974 , 7 , "device_actions_predefined" , "Stopping" , "en_US" , "en" , "US");
insert into name_master values(1975 , 5 , "device_actions_parameter" , "Keep-warm Duration" , "en_US" , "en" , "US");
insert into name_master values(1976 , 7 , "device_actions_parameter" , "Keep-Warm Duration" , "en_US" , "en" , "US");
insert into name_master values(1977 , 6 , "device_actions_parameter" , "Target Temperature" , "en_US" , "en" , "US");
insert into name_master values(1978 , 8 , "device_actions_parameter" , "Target Temperature" , "en_US" , "en" , "US");
insert into name_master values(1979 , 8 , "device_status_enum" , "Cooling down" , "en_US" , "en" , "US");
insert into name_master values(1980 , 9 , "device_status_enum" , "Heating up" , "en_US" , "en" , "US");
insert into name_master values(1981 , 10 , "device_status_enum" , "Keeping warm" , "en_US" , "en" , "US");
insert into name_master values(1982 , 11 , "device_status_enum" , "Ready" , "en_US" , "en" , "US");
insert into name_master values(1983 , 12 , "device_status_enum" , "Kettle released" , "en_US" , "en" , "US");
insert into name_master values(1984 , 4 , "device_actions" , "Abschalten" , "de_DE" , "de" , "DE");
insert into name_master values(1985 , 5 , "device_actions" , "Aufheizen" , "de_DE" , "de" , "DE");
insert into name_master values(1986 , 6 , "device_actions" , "Abkochen und abkühlen" , "de_DE" , "de" , "DE");
insert into name_master values(1987 , 3 , "device_events" , "Kocher aufgesetzt" , "de_DE" , "de" , "DE");
insert into name_master values(1988 , 4 , "device_events" , "Aufheizen gestartet" , "de_DE" , "de" , "DE");
insert into name_master values(1989 , 5 , "device_events" , "Warmhalten gestartet" , "de_DE" , "de" , "DE");
insert into name_master values(1990 , 6 , "device_events" , "Aufheizen beendet,  auf Zieltemperatur abkühlen" , "de_DE" , "de" , "DE");
insert into name_master values(1991 , 7 , "device_events" , "Aufheizen beendet" , "de_DE" , "de" , "DE");
insert into name_master values(1992 , 8 , "device_events" , "Kocher abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(1993 , 9 , "device_events" , "Abkühlen beendet, Zieltemperatur erreichet" , "de_DE" , "de" , "DE");
insert into name_master values(1994 , 10 , "device_events" , "Warmhalten beendet" , "de_DE" , "de" , "DE");
insert into name_master values(1995 , 11 , "device_events" , "Aufheizen abgebrochen, Taste betätigt" , "de_DE" , "de" , "DE");
insert into name_master values(1996 , 12 , "device_events" , "Abkühlen abgebrochen, Taste betätigt" , "de_DE" , "de" , "DE");
insert into name_master values(1997 , 13 , "device_events" , "Warmhalten abgebrochen, Taste betätigt" , "de_DE" , "de" , "DE");
insert into name_master values(1998 , 14 , "device_events" , "Aufheizen beendet, warmhalten" , "de_DE" , "de" , "DE");
insert into name_master values(1999 , 15 , "device_events" , "Abkühlen beendet, warmhalten" , "de_DE" , "de" , "DE");
insert into name_master values(2000 , 16 , "device_events" , "Aufheizen abgebrochen, Kocher abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(2001 , 17 , "device_events" , "Abkühlen abgebrochen, Kocher abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(2002 , 18 , "device_events" , "Warmhalten abgebrochen, Kocher abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(2003 , 8 , "device_status" , "Betriebsmodus" , "de_DE" , "de" , "DE");
insert into name_master values(2004 , 5 , "device_actions_predefined" , "Abkochen und abkühlen" , "de_DE" , "de" , "DE");
insert into name_master values(2005 , 6 , "device_actions_predefined" , "Aufheizen" , "de_DE" , "de" , "DE");
insert into name_master values(2006 , 7 , "device_actions_predefined" , "Abschalten" , "de_DE" , "de" , "DE");
insert into name_master values(2007 , 5 , "device_actions_parameter" , "Warmhaltedauer" , "de_DE" , "de" , "DE");
insert into name_master values(2008 , 7 , "device_actions_parameter" , "Warmhaltedauer" , "de_DE" , "de" , "DE");
insert into name_master values(2009 , 6 , "device_actions_parameter" , "Warmhaltetemperatur" , "de_DE" , "de" , "DE");
insert into name_master values(2010 , 8 , "device_actions_parameter" , "Zieltemperatur" , "de_DE" , "de" , "DE");
insert into name_master values(2011 , 8 , "device_status_enum" , "Abkühlen" , "de_DE" , "de" , "DE");
insert into name_master values(2012 , 9 , "device_status_enum" , "Aufheizen" , "de_DE" , "de" , "DE");
insert into name_master values(2013 , 10 , "device_status_enum" , "Warmhalten" , "de_DE" , "de" , "DE");
insert into name_master values(2014 , 11 , "device_status_enum" , "Bereit" , "de_DE" , "de" , "DE");
insert into name_master values(2015 , 12 , "device_status_enum" , "Abgehoben" , "de_DE" , "de" , "DE");
insert into name_master values(2016 , 1 , "common_labels" , "Name" , "en_US" , "en" , "US");
insert into name_master values(2017 , 2 , "common_labels" , "dS Device GTIN" , "en_US" , "en" , "US");
insert into name_master values(2018 , 3 , "common_labels" , "Model Name" , "en_US" , "en" , "US");
insert into name_master values(2019 , 4 , "common_labels" , "Model Version" , "en_US" , "en" , "US");
insert into name_master values(2020 , 5 , "common_labels" , "Article Identifier" , "en_US" , "en" , "US");
insert into name_master values(2021 , 6 , "common_labels" , "Product Id" , "en_US" , "en" , "US");
insert into name_master values(2022 , 7 , "common_labels" , "Vendor" , "en_US" , "en" , "US");
insert into name_master values(2023 , 8 , "common_labels" , "Vendor Id" , "en_US" , "en" , "US");
insert into name_master values(2024 , 9 , "common_labels" , "Device Class" , "en_US" , "en" , "US");
insert into name_master values(2025 , 10 , "common_labels" , "Device Class Version" , "en_US" , "en" , "US");
insert into name_master values(2026 , 1 , "common_labels" , "Name" , "de_DE" , "de" , "DE");
insert into name_master values(2027 , 2 , "common_labels" , "dS Device GTIN" , "de_DE" , "de" , "DE");
insert into name_master values(2028 , 3 , "common_labels" , "Modellbezeichnung" , "de_DE" , "de" , "DE");
insert into name_master values(2029 , 4 , "common_labels" , "Modellvariante" , "de_DE" , "de" , "DE");
insert into name_master values(2030 , 5 , "common_labels" , "Artikel Kennzeichnung" , "de_DE" , "de" , "DE");
insert into name_master values(2031 , 6 , "common_labels" , "Produkt Kennzeichnung" , "de_DE" , "de" , "DE");
insert into name_master values(2032 , 7 , "common_labels" , "Hersteller" , "de_DE" , "de" , "DE");
insert into name_master values(2033 , 8 , "common_labels" , "Hersteller Kennung" , "de_DE" , "de" , "DE");
insert into name_master values(2034 , 9 , "common_labels" , "Geräteklasse" , "de_DE" , "de" , "DE");
insert into name_master values(2035 , 10 , "common_labels" , "Geräteklassen version" , "de_DE" , "de" , "DE");
...
insert into name_device_labels values(4 , 1 , "de_DE" , "Bemerkungen" , "Bitte prüfen Sie mit der Smartphone App, ob die iKettle Firmware auf dem aktuellsten Stand ist!" , "de" , "DE");
