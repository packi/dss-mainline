...
#define XML_ENCODING "utf-8"
  ...
  bool PropertySystem::SaveToXML(const char* _fileName, PropertyNode* _rootNode) const {
    int rc;
    ...
    writer = xmlNewTextWriterFilename(_fileName, 0);
    if (writer == NULL) {
      return false;
    }
  ...
  PropertyNode* PropertySystem::GetProperty( const char* _propPath ) const {
    return GetProperty( string( _propPath ) );
  } // GetProperty
  ...
  int PropertySystem::GetIntValue( const char* _propPath ) const {
  ...
  bool PropertySystem::GetBoolValue( const char* _propPath ) const {
    PropertyNode* prop = GetProperty( _propPath );
    if( prop != NULL ) {
  ...
  const char* PropertySystem::GetStringValue( const char* _propPath ) const {
    PropertyNode* prop = GetProperty( _propPath );
    if( prop != NULL ) {
  ...
  bool PropertySystem::SetIntValue( const char* _propPath, const int _value, bool _mayCreate ) {
    if( _mayCreate ) {
  ...
  bool PropertySystem::SetBoolValue( const char* _propPath, const bool _value, bool _mayCreate ) {
    if( _mayCreate ) {
      PropertyNode* prop = CreateProperty( _propPath );
  ...
  bool PropertySystem::SetStringValue( const char* _propPath, const char* _value, bool _mayCreate ) {
    if( _mayCreate ) {
      PropertyNode* prop = CreateProperty( _propPath );
  ...
  const char* PropertyNode::GetStringValue() {
  ...
  bool PropertyNode::LinkToProxy( const PropertyProxy<const char*>& _proxy ) {
    if( m_LinkedToProxy ) {
      return false;
    }
  ...
  template <> const char* const PropertyProxy<const char*>::DefaultValue = "";
