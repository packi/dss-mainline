...
//          m_pPropertyNode->createProperty("name")->linkToProxy(PropertyProxyMemberFunction<Device, std::string>(*this, &Device::getName, &Device::setName));
  ...
  void Apartment::addDefaultGroupsToZone(Zone& _zone) {
    ...
    _zone.addGroup(grp);
    grp = new Group(GroupIDlight, zoneID, *this);
    grp->setName("light");
    _zone.addGroup(grp);
    grp = new Group(GroupIDshadow, zoneID, *this);
    grp->setName("shadow");
    _zone.addGroup(grp);
    grp = new Group(GroupIDclimate, zoneID, *this);
    grp->setName("climate");
    _zone.addGroup(grp);
    grp = new Group(GroupIDaudio, zoneID, *this);
    grp->setName("audio");
    _zone.addGroup(grp);
    grp = new Group(GroupIDvideo, zoneID, *this);
    grp->setName("video");
    _zone.addGroup(grp);
    grp = new Group(GroupIDsecurity, zoneID, *this);
    grp->setName("security");
    _zone.addGroup(grp);
    grp = new Group(GroupIDaccess, zoneID, *this);
    grp->setName("access");
    _zone.addGroup(grp);
    grp = new Group(GroupIDjoker, zoneID, *this);
    grp->setName("joker");
    _zone.addGroup(grp);
    grp = new Group(GroupIDcustom, zoneID, *this);
    grp->setName("custom");
    _zone.addGroup(grp);
