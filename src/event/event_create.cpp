...
boost::shared_ptr<Event>
createDeviceEventEvent(boost::shared_ptr<DeviceReference> _devRef, const std::string& name)
{
  boost::shared_ptr<Event> event;
                             ...
                             int _index, SensorType _type, int _value)
{
  ...
  double floatValue = sensorValueToDouble(_type, _value);
    ...
    switch (_properties.m_HeatingControlMode) {
      ...
      case HeatingControlMode::PID:
        event->setProperty("NominalTemperature_Off",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureSetpoint, _mode.OpModeTab[0])));
        event->setProperty("NominalTemperature_Comfort",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureSetpoint, _mode.OpModeTab[1])));
        event->setProperty("NominalTemperature_Economy",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureSetpoint, _mode.OpModeTab[2])));
        event->setProperty("NominalTemperature_NotUsed",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureSetpoint, _mode.OpModeTab[3])));
        event->setProperty("NominalTemperature_Night",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureSetpoint, _mode.OpModeTab[4])));
        event->setProperty("NominalTemperature_Holiday",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureSetpoint, _mode.OpModeTab[5])));
        event->setProperty("NominalTemperature_Cooling",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureSetpoint, _mode.OpModeTab[6])));
        event->setProperty("NominalTemperature_CoolingOff",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureSetpoint, _mode.OpModeTab[7])));
        break;
      case HeatingControlMode::ZONE_FOLLOWER:
        break;
      case HeatingControlMode::FIXED:
        event->setProperty("ControlValue_Off",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureControlVariable, _mode.OpModeTab[0])));
        event->setProperty("ControlValue_Comfort",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureControlVariable, _mode.OpModeTab[1])));
        event->setProperty("ControlValue_Economy",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureControlVariable, _mode.OpModeTab[2])));
        event->setProperty("ControlValue_NotUsed",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureControlVariable, _mode.OpModeTab[3])));
        event->setProperty("ControlValue_Night",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureControlVariable, _mode.OpModeTab[4])));
        event->setProperty("ControlValue_Holiday",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureControlVariable, _mode.OpModeTab[5])));
        event->setProperty("ControlValue_Cooling",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureControlVariable, _mode.OpModeTab[6])));
        event->setProperty("ControlValue_CoolingOff",
            doubleToString(sensorValueToDouble(SensorType::RoomTemperatureControlVariable, _mode.OpModeTab[7])));
        break;
      case HeatingControlMode::MANUAL:
        break;
    }
