...
namespace dss {
  ...
  public:
    ...
    void setButtonActiveGroup(int value) { m_ButtonActiveGroup = value; }
    ...
    void setDeviceBlinkRepetitions(uint8_t _count);
    void setDeviceBlinkOnDelay(double delay);
    void setDeviceBlinkOffDelay(double delay);
    void getDeviceBlinkSettings(double *_ondelay, double *_offdelay, uint8_t *_count);
