...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.11 2008-08-31 22:15:59 GMT")
...
{	int i, j;
	...
	if (soap->body && !*soap->href)
	{
		...
		{	if (soap_new_block(soap) == NULL)
				return NULL;
			for (a->__size = 0; ; a->__size++)
			{	p = (unsigned long *)soap_push_block(soap, NULL, sizeof(unsigned long));
				if (!p)
					return NULL;
...
SOAP_FMAC3 struct dss__Event_DeleteSchedule * SOAP_FMAC4 soap_in_dss__Event_DeleteSchedule(struct soap *soap, const char *tag, struct dss__Event_DeleteSchedule *a, const char *type)
{
	...
	size_t soap_flag__scheduleEventID = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
...
{
	size_t soap_flag__token = 1;
	size_t soap_flag__icalString = 1;
	size_t soap_flag__eventID = 1;
...
{
	size_t soap_flag_scheduledEventID = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
...
{
	size_t soap_flag__token = 1;
	size_t soap_flag__subscriptionID = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
...
{
	size_t soap_flag__token = 1;
	size_t soap_flag__eventIDs = 1;
	size_t soap_flag__sourceIDs = 1;
	size_t soap_flag__actionName = 1;
	size_t soap_flag__params = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
...
{
	size_t soap_flag__token = 1;
	size_t soap_flag__modulatorID = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
...
SOAP_FMAC3 struct dss__Device_StartDim * SOAP_FMAC4 soap_in_dss__Device_StartDim(struct soap *soap, const char *tag, struct dss__Device_StartDim *a, const char *type)
{
	size_t soap_flag__token = 1;
	size_t soap_flag__deviceID = 1;
	size_t soap_flag__directionUp = 1;
	size_t soap_flag__paramID = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
...
SOAP_FMAC3 struct dss__Set_Remove * SOAP_FMAC4 soap_in_dss__Set_Remove(struct soap *soap, const char *tag, struct dss__Set_Remove *a, const char *type)
{
	size_t soap_flag__token = 1;
	size_t soap_flag__setID = 1;
	size_t soap_flag__setIDToRemove = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
...
{
	size_t soap_flag__token = 1;
	size_t soap_flag__setID1 = 1;
	size_t soap_flag__setID2 = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
